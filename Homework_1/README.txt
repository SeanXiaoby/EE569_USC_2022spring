...
1. Open the source code in VScode and run it, or compile it in the terminal using "g++ .\EE569_HW1_Problem1.cpp -o EE569_Hw1_Problem1.exe" and run it.
...
1. Open the source code in VScode and run it, or compile it in the terminal using "g++ .\EE569_HW1_Problem2.cpp -o EE569_Hw1_Problem2.exe" and run it.
...
1. Open the source code in VScode and run it, or compile it in the terminal using "g++ .\EE569_HW1_Problem3.cpp -o EE569_Hw1_Problem3.exe" and run it.
